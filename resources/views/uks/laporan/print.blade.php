...
<head>
    ...
    <title>Cetak Laporan Kunjungan UKS — SmartSchool</title>
    <!-- Google Fonts -->
...
<body>
    ...
    {{-- Title --}}
    <h2 class="report-title">Laporan Kunjungan UKS</h2>
    ...
    <div class="metadata-grid">
        ...
        <span class="metadata-value">: {{ $kunjunganList->count() }} Kali</span>
    </div>
    ...
    <table class="report-table">
        ...
        <tbody>
            @forelse($kunjunganList as $index => $row)
                <tr>
            ...
            @empty
                <tr>
                    <td colspan="9" class="text-center" style="padding: 20px; color: #64748b;">Tidak ada data kunjungan.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
