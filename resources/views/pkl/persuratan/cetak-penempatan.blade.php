...
<head>
    <meta charset="UTF-8">
    <title>Surat Pengantar Penempatan PKL — {{ $surat->nomor_surat }}</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .print-btn { position: fixed; top: 16px; right: 16px; background: #10b981; color: #fff; border: none; padding: 10px 20px; border-radius: 8px; font-size: 13px; cursor: pointer; font-family: sans-serif; z-index: 999; }
...
<div class="page">
    ...
    <table class="nomor-tabel" style="margin:12px 0;">
        ...
        <tr><td>Hal</td><td>:</td><td><strong>Surat Pengantar Penempatan Siswa PKL</strong></td></tr>
    </table>
    ...
    <div class="isi">
        ...
        <p>Pelaksanaan PKL berlangsung dari <strong>{{ \Carbon\Carbon::parse($surat->gelombang?->tanggal_mulai)->translatedFormat('d F Y') }}</strong> sampai <strong>{{ \Carbon\Carbon::parse($surat->gelombang?->tanggal_selesai)->translatedFormat('d F Y') }}</strong>.</p>
