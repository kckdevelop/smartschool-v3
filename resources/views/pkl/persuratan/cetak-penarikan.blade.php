...
<head>
    <meta charset="UTF-8">
    <title>Surat Penarikan Peserta PKL — {{ $surat->nomor_surat }}</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Tabel Data Surat (Nomor, Lam, Hal) */
        .surat-meta {
            width: 100%;
            border-collapse: collapse;
            margin-top: 10px;
...
<div class="no-print-bar">
    <button type="button" onclick="window.print()" style="background:#f97316; color:#fff; border:none; padding:10px 18px; border-radius:8px; font-size:14px; font-weight:600; cursor:pointer; display:flex; align-items:center; justify-content:center; gap:8px;">
        🖨️ Cetak Surat Penarikan
    </button>
